...
My favorite part of the scene is the physically simulated solar system around the sun. I've included the Earth, the Moon, Jupiter, and the asteroid belt. There is a slider to control the value of the gravitational constant, which can make the planets fly off into the distance or crash into the sun depending on which direction you move it. I may add more planets, but if you still see this sentence then I probably didn't. 

Most of the shaders make use of perlin noise, FBM, and Worley noise for their effects. I combined a lot of these by displacing the inputs to create more interesting patterns, and I used the smoothstep function in various places to extract certain ranges of values.

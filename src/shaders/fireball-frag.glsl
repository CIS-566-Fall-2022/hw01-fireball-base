...
void main()
{
        ...
        //     color = vec3(color.x * bias(0.2f, heightStrength), 
        //                 color.y * bias(0.2f, heightStrength), 
        //                 color.z * bias(0.2f, heightStrength)) ; 

        // }
        // if(length(fs_Displacement) >= 0.10f){
        //     // color = vec3(color.x * 1.5f, color.y * 1.5f, color.g) *  bias(0.7f, heightStrength); 
        //     color = vec3(color.x * bias(0.7f, heightStrength), color.y * bias(0.7f, heightStrength), color.z); 

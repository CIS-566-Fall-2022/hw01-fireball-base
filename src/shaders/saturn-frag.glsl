...
vec3 saturnBaseColor1 = vec3(190.0, 193.0, 163.0) / 255.0;
vec3 saturnBaseColor2 = vec3(173.0, 156.0, 104.0) / 255.0;
vec3 saturnStormsBlueColor1 = vec3(48.0, 173.0, 240.0) / 255.0;
vec3 saturnStormsBlueColor2 = vec3(30.0, 118.0, 212.0) / 255.0 * 0.5;
